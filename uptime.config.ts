...
const pageConfig: PageConfig = {
  ...
  links: [
    { link: 'https://blog.icrs.top/', label: '博客' },
  ],
}
...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    },
    {
      ...
      name: 'Share',
      method: 'GET',
      target: 'https://box.icrs.top/',
      statusPageLink: 'https://box.icrs.top/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'Repo',
      method: 'GET',
      target: 'https://repo.icrs.top/',
      statusPageLink: 'https://repo.icrs.top/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'HK',
      method: 'GET',
      target: 'http://38.76.217.180:22',
      statusPageLink: 'http://38.76.217.180:22',
      hideLatencyChart: false,
      expectedCodes: [403],
      timeout: 10000,
    },
      ...
      name: 'US',
      method: 'GET',
      target: 'http://66.154.107.231:22',
      statusPageLink: 'http://66.154.107.231:11',
      hideLatencyChart: false,
      expectedCodes: [403],
      timeout: 10000,
    },
